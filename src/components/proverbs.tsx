// proverbs.tsx — legacy component (proverbs field removed from AgentState)
// Keeping for reference; not used in current WC2026 flow.
...
export function ProverbsCard({ state, setState }: ProverbsCardProps) {
  const proverbs = (state.proverbs as string[] | undefined) ?? [];
  return (
